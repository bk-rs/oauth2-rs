...
use super::internal_v4_profile_endpoint::{MeEndpoint, MeEndpointError, User};

//
#[derive(Debug, Clone)]
pub struct LinodeUserInfoEndpoint {
    inner: MeEndpoint,
}
impl LinodeUserInfoEndpoint {
...
impl Endpoint for LinodeUserInfoEndpoint {
