...
pub const TOKEN_URL: &str = "https://id.twitch.tv/oauth2/authorize";
pub const AUTHORIZATION_URL: &str = "https://id.twitch.tv/oauth2/token";
...
pub use additional_endpoints::TwitchEndpointBuilder;
