...
// Ref https://docs.microsoft.com/en-us/linkedin/consumer/integrations/self-serve/sign-in-with-linkedin
pub const URL: &str = "https://api.linkedin.com/v2/me";
